    ...
    <div className="space-y-6">
      <Card className="card-glass">
        <CardHeader>
          ...
          <CardDescription>
            How CoreAI uses artificial intelligence to enhance your DeFi experience
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="prose prose-invert max-w-none pt-24 md:pt-4">
                ...
                <p>
                  This multi-layered approach ensures that CoreAI provides accurate, helpful, and 
            ...
            <TabsContent value="models" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <p>
                  CoreAI leverages state-of-the-art AI models to power its intelligent features. 
                ...
                <div className="bg-cosmic-800 p-4 rounded-lg mt-4">
                  ...
                  <p className="mt-2">
                    ...
                    understanding and generation capabilities. This model enables CoreAI to:
                  </p>
                  <ul className="mt-2">
            ...
            <TabsContent value="data" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <p>
                  CoreAI's AI system integrates multiple data sources to provide comprehensive insights 
...
Clearly indicate when advice is speculative vs data-driven.`}
            ...
            <TabsContent value="limitations" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-lg mt-4">
                  ...
                  <p className="mt-2">
                    CoreAI's AI features are designed to assist with portfolio management and market analysis, 
      ...
      <Card className="card-glass">
        <CardHeader>
          ...
          <CardDescription>
            How our AI system is integrated into the CoreAI platform
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="prose prose-invert max-w-none">
            <p>
              CoreAI's AI capabilities are implemented through a sophisticated architecture that 
